                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <?php echo Form::open(['url' => 'fornecedores/'.$fornecedor->idFornecedor, 'method' => 'put']); ?>
                                ...
                                <div class="form-group<?php echo e($errors->has('nome') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="nome" type="text" class="form-control" name="nome" value="<?php echo e($fornecedor->nome); ?>" required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('cnpj') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="cnpj" type="text" class="form-control" name="cnpj" value="<?php echo e($fornecedor->cnpj); ?>" required autofocus>

                                        <?php if($errors->has('cnpj')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($fornecedor->cnpj); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group<?php echo e($errors->has('ie') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="ie" type="text" class="form-control" name="ie" value="<?php echo e($fornecedor->ie); ?>" autofocus>

                                        <?php if($errors->has('ie')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($fornecedor->ie); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group<?php echo e($errors->has('endereco') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="endereco" type="text" class="form-control"  value="<?php echo e($fornecedor->endereco); ?>" name="endereco" required autofocus>

                                        <?php if($errors->has('endereco')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($fornecedor->endereco); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group<?php echo e($errors->has('bairro') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="bairro" type="text" class="form-control" value="<?php echo e($fornecedor->bairro); ?>" name="bairro" required autofocus>

                                        <?php if($errors->has('bairro')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($fornecedor->bairro); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group<?php echo e($errors->has('cep') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="cep" type="text" class="form-control" value="<?php echo e($fornecedor->cep); ?>" name="cep" autofocus>

                                        <?php if($errors->has('cep')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($fornecedor->cep); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group<?php echo e($errors->has('fone') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="fone" type="text" class="form-control" value="<?php echo e($fornecedor->fone); ?>" name="fone" autofocus>

                                        <?php if($errors->has('fone')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($fornecedor->fone); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group<?php echo e($errors->has('celular') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="celular" type="text" class="form-control" name="celular" value="<?php echo e($fornecedor->celular); ?>" required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="email" type="email" class="form-control" name="email" value="<?php echo e($fornecedor->email); ?>" required autofocus>

                                        <?php if($errors->has('email')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($fornecedor->email); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
