                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <?php echo Form::open(['url' => 'ocs/'.$oc->idOC, 'method' => 'put']); ?>
                                ...
                                <div class="form-group<?php echo e($errors->has('tipo') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="tipo" type="text" class="form-control" name="tipo" value="<?php echo e($oc->tipo); ?>" required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('observacoes') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-10">
                                        <textarea id="observacoes" class="form-control" name="observacoes" value="<?php echo e($oc->observacoes); ?>" autofocus></textarea>
