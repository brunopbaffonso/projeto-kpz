                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group<?php echo e($errors->has('nome') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="nome" type="text" class="form-control" name="nome" value="<?php echo e(old('nome')); ?>" placeholder="João da Silva" maxlength="255" pattern="[a-zA-Z\s]+$" data-toggle="tooltip" data-placement="top" title="Esse campo aceita somente caracteres minúsculo/MAIÚSCULOS" required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('cnpj') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="cnpj" type="text" class="form-control" name="cnpj" value="<?php echo e(old('cnpj')); ?>" pattern="[0-9]+$"  maxlength="14" placeholder="00000000000000" data-toggle="tooltip" data-placement="top" title="Esse campo só aceita números de 0 a 9" autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('ie') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="ie" type="text" class="form-control" name="ie" value="<?php echo e(old('ie')); ?>" pattern="[0-9]+$"  maxlength="10" placeholder="0000000000" data-toggle="tooltip" data-placement="top" title="Esse campo só aceita números de 0 a 9" autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('cidade_idCidade') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="cidade_idCidade" type="cidade_idCidade" class="form-control" name="cidade_idCidade" value="<?php echo e(old('cidade_idCidade')); ?>" placeholder="Ex: Ponta Grossa" data-toggle="tooltip" data-placement="top" title="Esse campo aceita somente caracteres minúsculo/MAIÚSCULOS" required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('estado_uf') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="estado_uf" type="text" class="form-control" name="estado_uf" maxlength="2" pattern="[A-Z\s]+$" value="<?php echo e(old('estado_uf')); ?>" placeholder="PR" data-toggle="tooltip" data-placement="top" title="Esse campo aceita somente caracteres MAIÚSCULOS" required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('fone') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="fone" type="text" class="form-control" name="fone" value="<?php echo e(old('fone')); ?>" placeholder="(00)00000000" maxlength="12" pattern="[0-9]+$" data-toggle="tooltip" data-placement="top" title="Esse campo só aceita números de 0 a 9" required autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" placeholder="nome@mail.com.br" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" data-toggle="tooltip" data-placement="top" title="Esse campo aceita somente caracteres minúsculo/MAIÚSCULOS e caracteres especiais. Obrigatório o uso de @!" required autofocus>
