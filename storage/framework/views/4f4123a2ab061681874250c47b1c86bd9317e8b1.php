                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal" for="quantidade" class="col-md-2 control-label">Código OS:</label>  <?php echo e($OS->idOS); ?>

                            <div class="form-horizontal">
                                <?php echo Form::open(['url' => 'items/', 'method' => 'post', 'enctype' => 'multipart/form-data']); ?>

                                <input id="os_idOS" type="hidden" class="form-control" name="os_idOS" value="<?php echo e($OS->idOS); ?>">
                                ...
                                <div class="form-group<?php echo e($errors->has('arte') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="arte" type="file" name="arte" value="<?php echo e(old('arte')); ?>" autofocus>
