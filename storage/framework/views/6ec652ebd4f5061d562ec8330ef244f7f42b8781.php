                    ...
                    <div class="panel-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group<?php echo e($errors->has('cnpj') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                    <input id="cnpj" type="text" class="form-control" name="cnpj" value="<?php echo e(old('cnpj')); ?>" autofocus>
                            ...
                            <div class="form-group<?php echo e($errors->has('cidade_idCidade') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                    <input id="cidade_idCidade" type="cidade_idCidade" class="form-control" name="cidade_idCidade" value="<?php echo e(old('cidade_idCidade')); ?>" required autofocus>
