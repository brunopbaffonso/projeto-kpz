                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input id="nome" type="text" class="form-control" name="nome" value="{{ old('nome') }}" placeholder="Ex: Manta/Tinta" data-toggle="tooltip" data-placement="top" title="Tooltip on top" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('quantidade') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input id="quantidade" type="text" class="form-control" name="quantidade" value="{{ old('quantidade') }}" placeholder="Ex: 1 Rolo/10 Latas" data-toggle="tooltip" data-placement="top" title="Tooltip on top" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('comprimento') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input id="comprimento" type="text" class="form-control" name="comprimento" value="{{ old('comprimento') }}" placeholder="Ex: 0.60/0.90" data-toggle="tooltip" data-placement="top" title="Tooltip on top" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('largura') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input id="largura" type="text" class="form-control" name="largura" value="{{ old('largura') }}" placeholder="Ex: 0.60/0.90" data-toggle="tooltip" data-placement="top" title="Tooltip on top" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('precoUnit') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input id="precoUnit" type="text" class="form-control" name="precoUnit" value="{{ old('precoUnit') }}" placeholder="Ex: R$ 10.00/ R$270.55" data-toggle="tooltip" data-placement="top" title="Tooltip on top" required autofocus>
